...
export function createSetupEmbed(
  ...
  embed.addFields(
    ...
    { name: 'Page 4:', value: 'League Staff - Set up staff roles and permissions', inline: true },
    { name: 'Page 5:', value: 'Transaction Settings - Configure currency and trade settings', inline: true },
